    ...
    return (
        <section className="account-wrap">
            ...
            <div className="balance-info">
                <div className="b-avail">可用返利<b>（等待确认：{account.balanceMajor.pendingAmount}）</b></div>
                <div className="b-amount">
                    <div className="b-yuan"><strong>{account.balanceMajor.availableAmount}</strong>元</div>
