...
class LoginPage extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <CheckTab changeTab={this.handleClickTab} selectedIndex={selectedIndex}></CheckTab>
        <div className="form-wrap">
          <LoginForm showError={this.handleModalOpen} submitLogin={this.submitLogin} selectedIndex={selectedIndex}></LoginForm>
          <RegisterForm showError={this.handleModalOpen} submitReg={this.submitReg} selectedIndex={selectedIndex}></RegisterForm>
        </div>
        <Modal isOpen={modal.modalIsOpen} onAfterOpen={this.afterOpenModal} onRequestClose={this.closeModal} style={customStyles}>
